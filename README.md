...
| Quasar Typescript Admin Template| [github](https://github.com/dirkhe1051931999/quasar-typescript-admin-template), [website](https://dirkhe1051931999.github.io/) | 💫 💫 template for quasar admin with typescript 🌝 🌝 support pwa,electron,spa,Ionic | v2.10.1 |
...
| Trainero.com | [website](https://trainero.com), [iOS](https://itunes.apple.com/fi/app/trainerocomtrainerapp/id1439762339), [android](https://play.google.com/store/apps/details?id=com.trainero.app_trainer) | All-in-one App for a Personal Trainer with +35000 users world-wide. Apps built with Capacitor. | v1.15.0 |
...
| Yawik Application Form | [gitlab](https://gitlab.com/yawik/applicationform), [website](https://form.yawik.org) | Application Form which can be used to apply for job postings | v2.4 (patched) |
| Yawik Jobboard | [gitlab](https://gitlab.com/yawik/jobborad), [website](https://jobboard.yawik.org) | real jobboard with real jobs | v2.4 |
| Yawik Jobwizard | [gitlab](https://gitlab.com/yawik/jobwizard), [website](https://jobwizard.yawik.org) | Jobad generator with Google Jobs JSON-LD. Can authenticate against a keycloak | v2.4 (patched) |
